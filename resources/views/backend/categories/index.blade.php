                ...
                <div class="panel-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- <button type="submit"  data-toggle="modal"  data-target="#myModaldelete" data-cat_id="{{$category->id}}" class="btn btn-danger btn-xs" >Delete</button> -->
                                    <a href="" data-toggle="modal"  data-target="#myModaldelete" data-cat_id="{{$category->id}}" class="btn btn-danger btn-xs">Delete</a>
                                </td>
